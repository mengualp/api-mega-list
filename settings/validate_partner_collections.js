...
const featuredLanding = fs.readFileSync(path.join(root, '00-featured-partners', 'README.md'), 'utf8');
const apyhubReadme = fs.readFileSync(path.join(root, '00-featured-partners', 'apyhub-utility-apis', 'README.md'), 'utf8');
const coreclawReadme = fs.readFileSync(path.join(root, '00-featured-partners', 'coreclaw-scraper-apis', 'README.md'), 'utf8');
...
check(mainReadme.includes('(./00-featured-partners/apyhub-utility-apis/)'), 'Main README is missing the ApyHub partner collection');
check(mainReadme.includes('(./00-featured-partners/coreclaw-scraper-apis/)'), 'Main README is missing the CoreClaw partner collection');
check(featuredLanding.includes('(./apyhub-utility-apis/)'), 'Featured partners page is missing the ApyHub collection');
check(featuredLanding.includes('(./coreclaw-scraper-apis/)'), 'Featured partners page is missing the CoreClaw collection');
